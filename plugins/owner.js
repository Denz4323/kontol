...
let handler = async(m, { conn, text, usedPrefix, command }) => {
    ...
    orderTitle: ``,
    thumbnail: await conn.resize(await (await fetch('https://telegra.ph/file/988091e9784f2780c8227.jpg')).buffer(), 300, 200) //Gambarnye

    }
    }
    }
    let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : m.fromMe ? conn.user.jid : m.sender
    let pp = await conn.profilePictureUrl(who, 'image').catch((_) => "https://telegra.ph/file/988091e9784f2780c8227.jpg")
	conn.p[id] = [
