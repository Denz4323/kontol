...
title: 'AUDIO',
body: 'Denn BOT',         
previewType: 0, thumbnail: await (await fetch(`https://i.ibb.co/zbbQhX7/cocin.jpg`)).buffer(),
...
title: 'VIDEO',
body: 'Denn BOT',         
previewType: 0, thumbnail: await (await fetch('https://telegra.ph/file/a817b4aaa72af31a0fec5.jpg')).buffer(),
sourceUrl: `https://youtube.com/@DenzCreator`}}})
let res = await fetch("https://api.dhamzxploit.my.id/api/ytplaymp4?text="+text)
let json = await res.json()
conn.sendFile(m.chat, json.result.url, 'error.mp4', `Denm BOT`, m)}
}catch(e){
